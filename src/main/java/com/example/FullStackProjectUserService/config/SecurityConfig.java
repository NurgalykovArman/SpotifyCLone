package com.example.FullStackProjectUserService.config;


import com.example.FullStackProjectUserService.filter.JwtAuthFilter;
...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers("/auth/**","/api/**", "/**", "/swagger-ui/**").permitAll()
                .and()
